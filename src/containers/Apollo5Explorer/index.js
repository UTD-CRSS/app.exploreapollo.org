...
import apollo5logo from "../../../static/FastFactsimgs/apollo5logo.png";
      ...
      <div className="app-container">
        ...
        <div className="row fastfacts">
          <div className="col-sm-6">
            ...
            This was the first unmanned flight of the Apollo Lunar Module, which
            would later carry astronauts to the luanr surface. <br></br>
            <br></br>
          </div>
          <div className="col-sm-6">
            <img
