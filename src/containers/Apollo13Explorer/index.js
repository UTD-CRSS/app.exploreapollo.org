      ...
      <div className="app-container">
        ...
        <div className="row fastfacts">
          <div className="col-sm-6 fastfactstext">
            ...
            3. The command module on the Odyssey was completely damaged, so they
            used the Aquarius lunar module to come back to Earth. (This is what
            they were supposed to use when they landed on the moon). <br></br>
            ...
            moon. <br></br>
            3. The primary goal of this mission was to study Earth's origin. The
            plan was to land near the Fra Mauro crater. <br></br>
            4. The Fra Mauro crater had material from when the moon was first
            created. <br></br>
            5. This mission brought about a very famous quote: "Houston, we have
            a problem." <br></br>
            <br></br>
            <h4>
              <b> Crew: </b>
