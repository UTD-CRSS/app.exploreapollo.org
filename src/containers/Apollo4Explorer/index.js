...
import apollo4logo from "../../../static/FastFactsimgs/apollo4logo.png";
      ...
      <div className="app-container">
        ...
        <div className="row fastfacts">
          <div className="col-sm-6">
            ...
            5. It was launched from the Kennedy Space Center for the first time.{" "}
            <br></br> <br></br>
            <h4>
              <b> Significance: </b>
            </h4>
            This was the first unmanned flight to successfully carry the Apollo
            Command and Service Module into Earth's orbit. <br></br>
            <br></br>
          </div>
          <div className="col-sm-6">
            <img
