...
export function LessonList() {
  return (
    <div className="app-container">
      ...
      <button className="btn-dark addpadding btn-lg">
        <a
      ...
      <button className="btn-info btn-lg flex-grow-1 addpadding">
        <a
      ...
      <button className="btn-primary btn-lg flex-grow-1 addpadding">
        <a href="">
          {" "}
          <font>Tech: Coming Soon</font>{" "}
        </a>
      </button>
      <button className="btn-secondary btn-lg flex-grow-1 addpadding">
        <a href="">
          {" "}
