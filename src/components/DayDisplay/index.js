...
export class DayDisplay extends Component {
  render() {
    ...
    switch (day) {
      ...
      case "1":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day1.jpg";
      ...
      case "5":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day5.jpg";
      ...
      case "6":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day6.jpg";
      ...
      case "7":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day7.jpg";
        label = "Day 7 - July 22nd, 1969";
        text =
          "On this day, the spacecraft begins its transearth injection burn, sending the crew homeward. As it begins to be pulled in by the Earth's gravity, the crew makes a slight course correction and then later performs another live telecast to Earth.";
        break;
      case "8":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day8.jpg";
        label = "Day 8 - July 23rd, 1969";
        text =
          "A very uneventful day, the spacecraft continues its path towards Earth as the crew performs checks on all systems and talks with Mission Control. This evening, the final color TV transmission is made.";
        break;
      case "9":
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/day9.jpg";
      ...
      default:
        imgUrl =
          "https://s3.amazonaws.com/exploreapollo-data/static-photos/apollodiagram/base.jpg";
        label = "";
        text = "";
    }
    return (
